...
<table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;">
  <tr style="background-color: #f5f5f5;">
    ...
    <td>nomsmta</td>
    <td style="font-style: italic;">飲んでしまった</td>
  </tr>
  <tr style="background-color: #f5f5f5;">
    <th style="background-color: #e6e6e6;">未来結果状態相</th>
    <td>nomtro</td>
    <td style="font-style: italic;">飲んでいるだろう</td>
  </tr>
  <tr style="background-color: #f5f5f5;">
    <th style="background-color: #e6e6e6;">過去起動相</th>
    <td>nomdsta</td>
    <td style="font-style: italic;">飲み始めた</td>
  </tr>
  <tr style="background-color: #f5f5f5;">
    <th style="background-color: #e6e6e6;">義務完遂相</th>
    <td>nomsmbka</td>
    <td style="font-style: italic;">飲んでしまわなければならない</td>
  </tr>
  <tr style="background-color: #f5f5f5;">
    <th style="background-color: #e6e6e6;">条件完遂相</th>
    <td>nomsmro</td>
    <td style="font-style: italic;">飲んでしまえば</td>
  </tr>
</table>

## 例文
1. vtʃi mz̩o nomaw. (私は水を飲みます。)
2. çiti jaksno nomta. (人は薬を飲んだ。)
3. antp kino sakeo nomtap ka? (あなたは昨日酒を飲みましたか？)
4. kara nomtasma hn̩o jome. (彼は飲み終わってから本を読む。)

## 関連語
- nommn: 飲み物（「飲む」+「もの」の複合語）
- nomdsm: 飲み始める（「飲む」+起動相「dsm」接尾辞）
- nomsm: 飲み切る（「飲む」+完遂「sm」接尾辞）
- tben: 食べる（関連基本動詞）
- tbenom: 食べ飲み（「食べる」+「飲む」の複合語）

## 備考
「nom」は日常的な基本動詞で、飲食に関する表現に必須です。後舌母音系動詞として、活用形に後舌母音が現れます。丁寧表現では「nommasaw」（飲みます）などの形が使われます。「jknom」（よく飲む、大酒飲みである）のように習慣・頻度を表す接頭辞「jk-」と組み合わせることも一般的です。

身体活動や生理現象を表す基本的な動詞として、様々なアスペクト標識と組み合わせて使用されます：
- nomtra (飲んでいる)
- nomsmta (飲んでしまった)
- nomtko (飲んでおこう)

比喩的には「知識を飲む」（知識を吸収する）、「怒りを飲む」（怒りを抑える）などの表現にも使用されます。また、「mz̩」（水）や「sake」（酒）などの液体名詞と共に使われることが多く、これらの名詞と組み合わせて複合語を形成することもあります（「mz̩nom」（水飲み）、「sakenom」（酒飲み）など）。
