...
## 関連語
- kars: 彼/彼女自身（再帰形）
- karlve: 彼らは（対比トピック標識付き）
- kartra: 彼はいる（「kar ara」の縮約形）
- karltra: 彼らはいる（「karl ara」の縮約形）

## 備考
「kar」は性別を区別しない3人称代名詞として機能し、文脈によって「彼」または「彼女」を指します。ただし、文化的要素や文脈によっては、特定の性別を指す傾向があることもあります。文脈から明らかな場合は、所有関係を表す属格形「karne」が単独で使用されることもあります。複数形「karl」と共に、談話における参照と照応の中心的役割を果たします。
